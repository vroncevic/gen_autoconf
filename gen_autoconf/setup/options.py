...
Info
    GenAutoconf bundle options for the gen_autoconf bundle.
'''
...
class GenAutoconfBundleOptions(TypedDict):
    '''
        GenAutoconf bundle options for the gen_autoconf bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_autoconf bundle.
    '''
